    ...
    <form id="form1" runat="server">
        <div id="div_info" style="width:96%; margin:8px auto 0 auto;" >
            ...
            <tr>
                <th>地址：</th>
                <td>
                    <input type="text" name="Address" id="Address" class="mytext" value="" runat="server" style="width: 90%" />
                </td>
            </tr>
            <tr>
                <th>邮箱：</th>
                <td>
                    <input type="text" name="Email" id="Email" class="mytext" value="" runat="server" style="width: 90%" />
                </td>
            </tr>
            <tr>
                <th>QQ：</th>
