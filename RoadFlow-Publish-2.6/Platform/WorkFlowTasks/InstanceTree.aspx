...
<body>
    ...
    <script type="text/javascript">
        ...
        $(function ()
        {
            roadTree = new RoadUI.Tree({ id: "tree", path: "/Platform/Dictionary/Tree1.ashx?ischild=1&root=<%=rootid%>", refreshpath: "/Platform/Dictionary/TreeRefresh.ashx", onclick: openUrl });
        });
