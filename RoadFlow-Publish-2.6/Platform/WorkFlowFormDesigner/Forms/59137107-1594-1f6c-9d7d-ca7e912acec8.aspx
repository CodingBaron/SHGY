...
<%
	...
	LitJson.JsonData initData = BWorkFlow.GetFormData(DBConnID, DBTable, DBTablePK, InstanceID, fieldStatus, "{\"temptest.date1\":\"yyyy-MM-dd\",\"temptest.date2\":\"yyyy-MM-dd\"}", TaskID);
