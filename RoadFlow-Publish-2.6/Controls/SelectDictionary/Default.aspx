        ...
        $(function ()
        {
            switch (datasource)
            {
                ...
                case "1": //SQL
                    ...
                    roadTree = new RoadUI.Tree({
                        id: "dict", path: "/Controls/SelectDictionary/GetJson_SQL.ashx?dbconn=" + dbconn + "&sql=" + sql,
                ...
                case "3": //表
                    ...
                    roadTree = new RoadUI.Tree({
                        id: "dict", path: "/Controls/SelectDictionary/GetJson_Table.ashx?dbconn=" + dbconn + "&dbtable=" + dbtable
                        + "&valuefield=" + valuefield + "&titlefield=" + titlefield + "&parentfield=" + parentfield + "&where=" + where,
                        refreshpath: "/Controls/SelectDictionary/GetJson_TableRefresh.ashx?dbconn=" + dbconn + "&dbtable=" + dbtable
